...
func TestFailPut(t *testing.T) {
	...
	if v2.Primary != s1.me || v2.Backup != s3.me {
		print("\n" + "view prim = " + v2.Primary + " view back = " + v2.Backup + "\n")
		print("pb1 prim = " + s1.Primary + "pb1 back = " + s1.Backup + "\n")
		print("pb3 prim = " + s3.Primary + "pb3 back = " + s3.Backup + "\n")
		print("correct prim = " + s1.me + "correct back = " + s3.me + "\n")
